...
@group(1) @binding(0) var uScreenTexture: texture_depth_2d_array;
...
fn fs_main(in: VertexOutput) -> @location(0) vec4f {
    ...
    var lvl: i32 = 0;
    let depth = textureSample(uScreenTexture, uTextureSampler, in.uv, lvl);
    return vec4f(vec3f(depth), 1.0f);
}