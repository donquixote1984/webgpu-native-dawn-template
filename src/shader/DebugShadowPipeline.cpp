#include "DebugShadowPipeline.h"

DebugShadowPipeline::DebugShadowPipeline()
{
    m_Shader = Shader("resources/shaders/debug_shadow.wgsl");
    ...
    m_TextureBindGroupOptions.push_back({0, BindGroupType::DEPTH_ARRAY});
    // samplers
    m_SamplerBindGroupOptions.push_back({0, BindGroupType::SAMPLER});

}
void DebugShadowPipeline::CreatePipeline()
{
...
void DebugShadowPipeline::CreateBindGroupLayout()
{
      // uniform
