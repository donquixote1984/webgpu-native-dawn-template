#include "DebugWindowPipeline.h"
DebugWindowPipeline::DebugWindowPipeline()
{
    m_Shader = Shader("resources/shaders/debug_window.wgsl");
    ...
    m_TextureBindGroupOptions.push_back({0, BindGroupType::TEXTURE});
    // samplers
...
void DebugWindowPipeline::CreatePipeline()
{
...
void DebugWindowPipeline::CreateBindGroupLayout()
{
      // uniform
