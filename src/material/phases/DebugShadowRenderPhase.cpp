#include "DebugShadowRenderPhase.h"
DebugShadowRenderPhase::DebugShadowRenderPhase()
{
     m_Pipeline = DebugShadowPipeline::Get();
     CreateBindGroups();
}
void DebugShadowRenderPhase::CreateTextureBindGroup()
{
    ...
    binding.binding = 0;
    binding.textureView = SceneShadowMapCSMTexture::Get()->GetReaderTextureView();
